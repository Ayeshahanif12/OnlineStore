<?php
include '../config.php'; // Assuming newsletter folder is directly under OnlineStore, so ../config.php
...
<body>
    <div class="sidebar d-flex flex-column p-3">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="<?php echo BASE_URL; ?>/newsletter/fetchnewsletter.php" class="nav-link active">
                    ...
                    <?php if (!empty($dataAll)): ?>
                        <?php foreach ($dataAll as $rows): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($rows['whatsappno']) ?></td>
                                <td><?= htmlspecialchars($rows['subscribe_date'] ?? 'N/A') ?></td>
                                <td><a href="deletenewsletter.php?id=<?= $rows['id'] ?>" id="delete-btn">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
